    ...
    <div className={`${darkMode ? "bg-primary-black text-white" : "bg-white text-black border-b-0 border-black"}`}>
      <nav className="flex select-none items-center justify-between gap-4 px-5">
                ...
                {Array.isArray(item.value) ? (
                  ...
                  <NewThread>
                    ...
                    <Image
                      ...
                      className={`${darkMode ? "filter-white" : "filter-black"}`}
                    />
                  ...
                  <Button
                    className={`relative w-5 h-5 object-contain p-2 items-center justify-center focus:outline-none focus:ring-0 ${
                      darkMode ? "border-gray-300 text-white" : "text-black"
                    }`}
                  >
                    <Image
                      src={item.icon}
                      ...
                      fill
                      sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 20vw"
                      className={`${darkMode ? "invert" : ""}`} // Change icon color based on dark mode
                    />
                  </Button>
                )}
              </li>
        ...
        <div className={`flex space-x-4 ${darkMode ? "text-white" : "text-black"}`}>
          <Link href="/" className="hover:underline transition duration-300 ease-in-out">
            Home
          </Link>
          <Link href="/faq" className="hover:underline transition duration-300 ease-in-out">
            FAQ
          </Link>
        </div>
