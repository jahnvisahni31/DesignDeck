...
import { Navbar, Link, Button, Image, Card, CardFooter } from "@nextui-org/react";
...
export default function App() {
  ...
  const icons = {
    chevron: <ChevronDown fill="currentColor" size={16} height={undefined} width={undefined} className="some-class-name" />,
    hammer: <ImHammer />,
    dev: <ImDeviantart />,
    slide: <ImNewspaper />,
    download: <ImDownload />,
